...
public class ReferenceSetEvaluator_Removal {

	public static void main(String[] args) throws Exception{
		
		File file = new File("err_removal.txt");
		...
		File commitFile = new File("/Users/Dante/Documents/workspace/eclipse_workspaces/fevers/LinuxAnalyzer/src/resources/ref_removals.csv");
		
		File outputFile = new File("comparison_golden_set_removal.csv");
		
		outputFile.createNewFile();
		FileWriter writer = new FileWriter(outputFile);

		writer.append("commit,feature name, reference pattern, found pattern, comparison\n");
